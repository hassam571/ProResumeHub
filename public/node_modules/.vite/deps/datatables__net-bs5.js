...
init_jquery_dataTables();
import_jquery.default.extend(true, jquery_dataTables_default.defaults, {
  dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
  renderer: "bootstrap"
});
import_jquery.default.extend(jquery_dataTables_default.ext.classes, {
...
jquery_dataTables_default.ext.renderer.pageButton.bootstrap = function(settings, host, idx, buttons, page, pages) {
  ...
  var attach = function(container, buttons2) {
    ...
    var clickHandler = function(e) {
      e.preventDefault();
      if (!(0, import_jquery.default)(e.currentTarget).hasClass("disabled") && api.page() != e.data.action) {
    ...
    for (i = 0, ien = buttons2.length; i < ien; i++) {
      ...
      if (Array.isArray(button)) {
        ...
        if (btnDisplay) {
          ...
          node = (0, import_jquery.default)("<li>", {
            "class": classes.sPageButton + " " + btnClass,
            "id": idx === 0 && typeof button === "string" ? settings.sTableId + "_" + button : null
          }).append(
            (0, import_jquery.default)("<a>", {
              "href": disabled ? null : "#",
  ...
  var hostEl = (0, import_jquery.default)(host);
  var activeEl;
  try {
