    ...
    (function(factory) {
      ...
      $.extend(Responsive.prototype, {
        ...
        _constructor: function() {
          ...
          $(window2).on("resize.dtr orientationchange.dtr", DataTable.util.throttle(function() {
        ...
        _classLogic: function() {
          ...
          var columns = dt.columns().eq(0).map(function(i) {
            ...
            if (priority === undefined) {
              priority = dataPriority === undefined || dataPriority === null ? 1e4 : dataPriority * 1;
            }
            return {
              className,
              includeIn: [],
          ...
          return function(api, rowIdx, columns) {
            ...
            var data = $.each(columns, function(i, col) {
              if (col.hidden) {
                ...
                ).append($('<span class="dtr-data"/>').append(_childNodes(api, col.rowIndex, col.columnIndex))).appendTo(ul);
                found = true;
              }
            });
...
export default require_dataTables_responsive();
