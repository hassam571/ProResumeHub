    ...
    position: function() {
      if (typeof this.options.position === "string" && $.inArray(this.options.position, this._positionClasses) !== -1) {
        if (this.options.position === "bottom-center") {
          this._container.css({
            left: $(window2).outerWidth() / 2 - this._container.outerWidth() / 2,
            bottom: 20
          });
          ...
          this._container.css({
            left: $(window2).outerWidth() / 2 - this._container.outerWidth() / 2,
            top: $(window2).outerHeight() / 2 - this._container.outerHeight() / 2
          });
        } else {
...
//# sourceMappingURL=jquery-toast-plugin_src_jquery__toast.js.map
