...
(function($) {
  ...
  $.fn.rateit = function(p1, p2) {
    ...
    var tp1 = typeof p1;
    if (tp1 == "object" || p1 === void 0 || p1 === null) {
      options = $.extend({}, $.fn.rateit.defaults, p1);
    } else if (tp1 == "string" && p1 !== "reset" && p2 === void 0) {
    ...
    return this.each(function() {
      ...
      var itemdata = function(key, value) {
        if (value != null) {
          ...
          var range2 = item.find(".rateit-range");
          if (range2.attr(ariakey) != void 0) {
            range2.attr(ariakey, value);
          }
        }
      ...
      if (!itemdata("init")) {
        ...
        itemdata("readonly", itemdata("readonly") !== void 0 ? itemdata("readonly") : options.readonly);
        itemdata("resetable", itemdata("resetable") !== void 0 ? itemdata("resetable") : options.resetable);
        itemdata("backingfld", itemdata("backingfld") || options.backingfld);
        itemdata("starwidth", itemdata("starwidth") || options.starwidth);
        itemdata("starheight", itemdata("starheight") || options.starheight);
        itemdata("value", Math.max(itemdata("min"), Math.min(itemdata("max"), !isNaN(itemdata("value")) ? itemdata("value") : !isNaN(options.value) ? options.value : options.min)));
        itemdata("ispreset", itemdata("ispreset") !== void 0 ? itemdata("ispreset") : options.ispreset);
        if (itemdata("backingfld")) {
      ...
      var calcRawScore = function(element2, event) {
        var pageX = event.changedTouches ? event.changedTouches[0].pageX : event.pageX;
        var offsetx = pageX - $(element2).offset().left;
        if (!ltr) {
      ...
      var setHover = function(score2) {
        var w = score2 * itemdata("starwidth") * itemdata("step");
        var h = range.find(".rateit-hover");
        if (h.data("width") != w) {
          range.find(".rateit-selected").hide();
          h.width(w).show().data("width", w);
          var data = [score2 * itemdata("step") + itemdata("min")];
      ...
      if (!itemdata("readonly")) {
        ...
        if (!itemdata("wired")) {
          range.on("touchmove touchend", touchHandler);
          range.on("mousemove", function(e) {
            var score2 = calcRawScore(this, e);
            setHover(score2);
          });
          ...
          range.on("mouseup", function(e) {
            var score2 = calcRawScore(this, e);
            var value = score2 * itemdata("step") + itemdata("min");
            setSelection(value);
            range.trigger("blur");
          });
...
jquery.rateit/scripts/jquery.rateit.js:
  ...
  *)
*/
//# sourceMappingURL=jquery__rateit_scripts_jquery__rateit.js.map
