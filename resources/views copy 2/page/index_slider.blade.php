						...
						<div class="swiper-container">
							<div class="swiper-wrapper">
								<div class="swiper-slide first">
									<div class="main-img" style="background-image: url('{{ asset('public/assets/images/started_image.jpg') }}');"></div>
								</div>
								<div class="swiper-slide">
									<div class="main-img" style="background-image: url('{{ asset('public/assets/images/started_image2.jpg') }}');"></div>
								</div>
								<div class="swiper-slide">
									<div class="main-img" style="background-image: url('{{ asset('public/assets/images/started_image3.jpg') }}');"></div>
								</div>
								<div class="swiper-slide">
									<div class="main-img" style="background-image: url('{{ asset('public/assets/images/started_image4.jpg') }}');"></div>
								</div>
							</div>
						</div>
					</div>
