...
@section('content')
			...
			<div class="section started section-title" id="section-started">
				...
				<!-- background -->
				<div class="video-bg jarallax" style="background-image: url('{{ asset('public/assets/images/works_single.jpg') }}');">
									...
									<div class="gallery-item">
										<p>
											<a href="images/work1.jpg">
												<img src="{{ asset('public/assets/images/work1.jpg') }}" alt="" />
											</a>
										</p>
										<p>
											<a href="images/work2.jpg">
												<img src="{{ asset('public/assets/images/work2.jpg') }}" alt="" />
											</a>
										</p>
										<p>
											<a href="images/work3.jpg">
												<img src="{{ asset('public/assets/images/work3.jpg') }}" alt="" />
											</a>
										</p>
									</div>
