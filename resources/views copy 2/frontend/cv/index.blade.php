			...
			<div class="section about" id="section-about">
				...
				<div class="content content-box">
					...
					<div class="image">
						...
						<img src="{{ $users->dp_path ? asset('storage/' . $users->dp_path) : asset('public/assets/images/man2.jpg') }}" alt="{{ $users->first_name }}'s Profile Picture" />
					</div>
							...
							<div class="team-col">
								<div class="team-item content-box">
									<div class="image">
										...
										<img src="{{ $teammate->dp_path ? asset('storage/' . $teammate->dp_path) : asset('public/assets/images/default-avatar.png') }}" alt="{{ $teammate->first_name }}" />
									</div>
									<div class="desc">
										...
										@if (!empty($users->fiverr_link))
											<li>
												<a href="{{ $users->fiverr_link }}" target="_blank">
													<img src="{{ asset('public/asset/images/social/fiverr.png') }}" alt="Fiverr" class="platform-icon">
													Fiverr
												</a>
											</li>
										@endif
										@if (!empty($users->upwork_link))
											<li>
												<a href="{{ $users->upwork_link }}" target="_blank">
													<img src="{{ asset('public/asset/images/social/upwork.png') }}" alt="Upwork" class="platform-icon">
													Upwork
												</a>
											</li>
										@endif
										@if (!empty($users->linkedin_link))
											<li>
												<a href="{{ $users->linkedin_link }}" target="_blank">
													<img src="{{ asset('public/asset/images/social/linkedin.png') }}" alt="LinkedIn" class="platform-icon">
													LinkedIn
												</a>
											</li>
										@endif
										@if (!empty($users->facebook_link))
											<li>
												<a href="{{ $users->facebook_link }}" target="_blank">
													<img src="{{ asset('public/asset/images/social/facebook.png') }}" alt="Facebook" class="platform-icon">
													Facebook
												</a>
											</li>
										@endif
										@if (!empty($users->instagram_link))
											<li>
												<a href="{{ $users->instagram_link }}" target="_blank">
													<img src="{{ asset('public/asset/images/social/insta.png') }}" alt="Instagram" class="platform-icon">
													Instagram
												</a>
											</li>
										@endif
										@if (!empty($users->other_platform))
											<li>
												<a href="{{ $users->other_platform }}" target="_blank">
													<img src="{{ asset('public/asset/images/social/other.png') }}" alt="Other" class="platform-icon">
													Other
												</a>
											</li>
										@endif
