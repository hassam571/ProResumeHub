...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('public/asset/plugins/notifications/css/lobibox.min.css') }}">
  <!--bootstrap css-->
...
<!--end sidebar-->
  ...
  <!--notification js -->
	<script src="{{ asset('public/asset/plugins/notifications/js/lobibox.min.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/notifications/js/notifications.min.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/notifications/js/notification-custom-script.js') }}"></script>
