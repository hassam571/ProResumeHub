            ...
            <div class="card-body p-0">
              <div class="user-list p-3">
                <div class="d-flex flex-column gap-3">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('public/asset/images/avatars/02.png') }}" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('public/asset/images/avatars/03.png') }}" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('public/asset/images/avatars/04.png') }}" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('public/asset/images/avatars/05.png') }}" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('public/asset/images/avatars/06.png') }}" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('public/asset/images/avatars/08.png') }}" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex flex-column gap-4">
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/11.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/10.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/13.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/01.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/02.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/06.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="{{ asset('public/asset/images/apps/04.png') }}" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
            ...
            <div class="card-header p-3">
              <div class="d-flex align-items-center gap-3">
                <div
                  ...
                  <img src="{{ asset('public/asset/images/avatars/11.png') }}" width="40" height="40" class="rounded-circle" alt="">
                  <div class="">
                    <h5 class="mb-0">65%</h5>
                    <p class="mb-0">Male</p>
                  </div>
                ...
                <div
                  ...
                  <img src="{{ asset('public/asset/images/avatars/12.png') }}" width="40" height="40" class="rounded-circle" alt="">
                  <div class="">
                    <h5 class="mb-0">35%</h5>
              ...
              <div class="d-flex flex-column justify-content-between gap-4">
                <div class="d-flex align-items-center gap-3">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="{{ asset('public/asset/images/apps/17.png') }}" width="32" alt="">
                    <p class="mb-0">Facebook</p>
                  </div>
                  <div class="">
                ...
                <div class="d-flex align-items-center gap-3">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="{{ asset('public/asset/images/apps/18.png') }}" width="32" alt="">
                    <p class="mb-0">LinkedIn</p>
                  </div>
                  <div class="">
                ...
                <div class="d-flex align-items-center gap-3">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="{{ asset('public/asset/images/apps/19.png') }}" width="32" alt="">
                    <p class="mb-0">Instagram</p>
                  </div>
                  <div class="">
                ...
                <div class="d-flex align-items-center gap-3">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="{{ asset('public/asset/images/apps/20.png') }}" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-3">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="{{ asset('public/asset/images/apps/05.png') }}" width="32" alt="">
                    <p class="mb-0">Google</p>
                  </div>
                  <div class="">
                ...
                <div class="d-flex align-items-center gap-3">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="{{ asset('public/asset/images/apps/08.png') }}" width="32" alt="">
          ...
          <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4 g-3">
            <div class="col">
              <div class="card rounded-4 mb-0 border">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <img src="{{ asset('public/asset/images/apps/05.png') }}" width="35" alt="">
                    <div class="dropdown">
                      <a href="javascript:;" class="dropdown-toggle-nocaret options dropdown-toggle"
                        data-bs-toggle="dropdown">
                        <span class="material-icons-outlined fs-5">more_vert</span>
            ...
            <div class="col">
              <div class="card rounded-4 mb-0 border">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <img src="{{ asset('public/asset/images/apps/18.png') }}" width="35" alt="">
                    <div class="dropdown">
                      <a href="javascript:;" class="dropdown-toggle-nocaret options dropdown-toggle"
                        data-bs-toggle="dropdown">
                        <span class="material-icons-outlined fs-5">more_vert</span>
            ...
            <div class="col">
              <div class="card rounded-4 mb-0 border">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <img src="{{ asset('public/asset/images/apps/17.png') }}" width="35" alt="">
                    <div class="dropdown">
                      <a href="javascript:;" class="dropdown-toggle-nocaret options dropdown-toggle"
                        data-bs-toggle="dropdown">
                        <span class="material-icons-outlined fs-5">more_vert</span>
            ...
            <div class="col">
              <div class="card rounded-4 mb-0 border">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <img src="{{ asset('public/asset/images/apps/19.png') }}" width="35" alt="">
                    <div class="dropdown">
                      <a href="javascript:;" class="dropdown-toggle-nocaret options dropdown-toggle"
                        data-bs-toggle="dropdown">
                        <span class="material-icons-outlined fs-5">more_vert</span>
        ...
        <div class="col d-flex">
          <div class="card w-100 rounded-4">
            ...
            <div class="card-body">
              <div class="d-flex flex-column gap-3">
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/01.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/02.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/03.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/04.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/05.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/06.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/top-products/07.png') }}" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex flex-column gap-4">
                   <div class="d-flex align-items-center gap-3">
                     <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                         <img src="{{ asset('public/asset/images/county/01.png') }}" width="40" alt="">
                         <div class="">
                   ...
                   <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="{{ asset('public/asset/images/county/02.png') }}" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="{{ asset('public/asset/images/county/03.png') }}" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="{{ asset('public/asset/images/county/04.png') }}" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="{{ asset('public/asset/images/county/05.png') }}" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="{{ asset('public/asset/images/county/06.png') }}" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="{{ asset('public/asset/images/county/07.png') }}" width="40" alt="">
                        <div class="">
        ...
        <div class="col-12 col-lg-4">
          <div class="card w-100 rounded-4">
            <div class="card-body">
              ...
              <div class="d-flex flex-column gap-4">
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/orders/01.png') }}" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/orders/08.png') }}" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/orders/03.png') }}" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/orders/04.png') }}" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/orders/05.png') }}" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('public/asset/images/orders/06.png') }}" width="75" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center flex-row gap-3">
                          <div class="">
                            <img src="{{ asset('public/asset/images/apps/paypal.png') }}" width="35" alt="">
                          </div>
                          <div class="">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center flex-row gap-3">
                          <div class="">
                            <img src="{{ asset('public/asset/images/apps/13.png') }}" width="35" alt="">
                          </div>
                          <div class="">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center flex-row gap-3">
                          <div class="">
                            <img src="{{ asset('public/asset/images/apps/behance.png') }}" width="35" alt="">
                          </div>
                          <div class="">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center flex-row gap-3">
                          <div class="">
                            <img src="{{ asset('public/asset/images/apps/07.png') }}" width="35" alt="">
                          </div>
                          <div class="">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center flex-row gap-3">
                          <div class="">
                            <img src="{{ asset('public/asset/images/apps/apple.png') }}" width="35" alt="">
                          </div>
                          <div class="">
              ...
              <div class="d-flex align-items-start justify-content-between mb-3">
                ...
                <div class="d-flex flex-column gap-4">
                   <div class="d-flex align-items-center gap-4">
                     <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                      <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                        <img src="{{ asset('public/asset/images/projects/angular.png') }}" width="30" alt="">
                      </div>
                        <div class="">
                   ...
                   <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                     <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                       <img src="{{ asset('public/asset/images/projects/react.png') }}" width="30" alt="">
                     </div>
                       <div class="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                     <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                       <img src="{{ asset('public/asset/images/projects/vue.png') }}" width="30" alt="">
                     </div>
                       <div class="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                     <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                       <img src="{{ asset('public/asset/images/projects/bootstrap.png') }}" width="30" alt="">
                     </div>
                       <div class="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                     <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                       <img src="{{ asset('public/asset/images/projects/magento.png') }}" width="30" alt="">
                     </div>
                       <div class="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                     <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                       <img src="{{ asset('public/asset/images/projects/django.png') }}" width="30" alt="">
                     </div>
                       <div class="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                     <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                       <img src="{{ asset('public/asset/images/projects/python.png') }}" width="30" alt="">
                     </div>
                       <div class="">
