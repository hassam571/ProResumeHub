...
<head>
  ...
  <link href="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet">
  <!--bootstrap css-->
...
<!--end sidebar-->
  ...
  <!-- Vector map JavaScript -->
	<script src="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-2.0.2.min.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-in-mill.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-us-aea-en.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-uk-mill-en.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/vectormap/jquery-jvectormap-au-mill.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/vectormap/jvectormap.custom.js') }}"></script>
