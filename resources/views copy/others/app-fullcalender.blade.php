...
<head>
  ...
  <link href="{{ asset('public/asset/plugins/fullcalendar/css/main.min.css') }}" rel="stylesheet">
...
<!--end sidebar-->
  ...
  <script src="{{ asset('public/asset/plugins/fullcalendar/js/main.min.js') }}"></script>
   <script>
