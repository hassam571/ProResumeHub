...
<!--end sidebar-->
  ...
  <script src="{{ asset('public/asset/plugins/validation/jquery.validate.min.js') }}"></script>
	<script src="{{ asset('public/asset/plugins/validation/validation-script.js') }}"></script>
	<script>
