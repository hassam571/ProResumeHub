            ...
            <div class="account-list d-flex flex-column gap-4">
                @if(!empty($user->fiverr_link))
                    <div class="account-list-item d-flex align-items-center gap-3">
                        <img src="{{ asset('public/asset/images/social/fiverr.png') }}" width="35" alt="Fiverr" />
                ...
                @if(!empty($user->upwork_link))
                    <div class="account-list-item d-flex align-items-center gap-3">
                        <img src="{{ asset('public/asset/images/social/upwork.png') }}" width="35" alt="Upwork" />
                        <div class="flex-grow-1">
                ...
                @if(!empty($user->linkedin_link))
                    <div class="account-list-item d-flex align-items-center gap-3">
                        <img src="{{ asset('public/asset/images/social/linkedin.png') }}" width="35" alt="LinkedIn" />
                        <div class="flex-grow-1">
                ...
                @if(!empty($user->facebook_link))
                    <div class="account-list-item d-flex align-items-center gap-3">
                        <img src="{{ asset('public/asset/images/social/facebook.png') }}" width="35" alt="Facebook" />
                        <div class="flex-grow-1">
                ...
                @if(!empty($user->instagram_link))
                    <div class="account-list-item d-flex align-items-center gap-3">
                        <img src="{{ asset('public/asset/images/social/insta.png') }}" width="35" alt="Instagram" />
                        <div class="flex-grow-1">
                ...
                @if(!empty($user->other_platform))
                    <div class="account-list-item d-flex align-items-center gap-3">
                        <img src="{{ asset('public/asset/images/social/other.png') }}" width="35" alt="Other Platform" />
                        <div class="flex-grow-1">
