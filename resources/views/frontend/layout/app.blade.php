...
<head>
	...
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/brown.css') }}" /> --}}
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/purple.css') }}" /> --}}
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/red.css') }}" /> --}}
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/beige.css') }}" /> --}}
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/green_light.css') }}" /> --}}
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/yellow.css') }}" /> --}}
	{{-- <link rel="stylesheet" href="{{ asset('assets/css/theme-colors/yellow_light.css') }}" /> --}}
...
<script type="text/javascript" src="{{ asset('assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyDz2w7HUaWudHwd7AWQpCL48Qs050WOn9s') }}"></script>
