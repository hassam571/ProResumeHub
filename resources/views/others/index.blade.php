                ...
                <div class="row">
                  <div class="col-12 col-sm-7">
                    <div class="d-flex align-items-center gap-3 mb-5">
                      <img src="{{ asset('asset/images/avatars/01.png') }}" class="rounded-circle bg-grd-info p-1"  width="60" height="60" alt="user">
                      <div class="">
                  ...
                  <div class="col-12 col-sm-5">
                    <div class="welcome-back-img pt-4">
                       <img src="{{ asset('asset/images/gallery/welcome-back-3.png') }}" height="180" alt="">
                    </div>
                  </div>
                </div><!--end row-->
              </div>
            ...
            <div class="card w-100 rounded-4">
              <div class="card-body">
                ...
                <div class="d-flex flex-column justify-content-between gap-4">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('asset/images/apps/07.png') }}" width="32" alt="">
                      <p class="mb-0">Spotify</p>
                    </div>
                    <div class="">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{ asset('asset/images/top-products/01.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{ asset('asset/images/top-products/02.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{ asset('asset/images/top-products/03.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{ asset('asset/images/top-products/04.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{ asset('asset/images/top-products/06.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
