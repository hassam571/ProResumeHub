    ...
    <div class="main-content">
      <!--breadcrumb-->
         ...
         <div class="card">
          ...
          <div class="card-body">
            <span class="btn btn-outline-primary">Primary</span>
            <span class="btn btn-outline-voilet">Secondary</span>
            <span class="btn btn-outline-success">Success</span>
            <span class="btn btn-outline-danger">Danger</span>
            <span class="btn btn-outline-warning text-dark">Warning</span>
            <span class="btn btn-outline-info text-dark">Info</span>
            <span class="badge bg-light text-white">Light</span>
            <span class="btn btn-outline-royal">Dark</span>
