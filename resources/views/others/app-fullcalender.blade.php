...
<head>
  ...
  <link href="{{ asset('asset/plugins/fullcalendar/css/main.min.css') }}" rel="stylesheet">
...
<!--end sidebar-->
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class=" -item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
  ...
  <script src="{{ asset('asset/plugins/fullcalendar/js/main.min.js') }}"></script>
   <script>
