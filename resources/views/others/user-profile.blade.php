        ...
        <div class="card rounded-4">
          <div class="card-body p-4">
             <div class="position-relative mb-5">
              <img src="{{ asset('asset/images/gallery/profile-cover.png') }}" class="img-fluid rounded-4 shadow" alt="">
              <div class="profile-avatar position-absolute top-100 start-50 translate-middle">
                <img src="{{ asset('asset/images/avatars/01.png') }}" class="img-fluid rounded-circle p-1 bg-grd-danger shadow" width="170" height="170" alt="">
              </div>
             </div>
            ...
            <div class="card rounded-4">
              <div class="card-body">
                ...
                <div class="account-list d-flex flex-column gap-4">
                  ...
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('asset/images/apps/02.png') }}" width="35" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('asset/images/apps/03.png') }}" width="35" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('asset/images/apps/06.png') }}" width="35" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('asset/images/apps/11.png') }}" width="35" alt="">
                    <div class="flex-grow-1">
