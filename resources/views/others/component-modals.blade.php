                                ...
                                <div class="card-body">
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                      <img src="{{ asset('asset/images/top-products/06.png') }}" width="60" height="60" alt="Product">
                                    </a>
                                    <div class="ps-2">
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                      <img src="{{ asset('asset/images/top-products/05.png') }}" width="60" height="60" alt="Product">
                                    </a>
                                    <div class="ps-2">
                                      <h6 class="mb-1"><a href="javascript:;" class="text-white">White Polo T-Shirt</a>
                                      </h6>
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                      <img src="{{ asset('asset/images/top-products/04.png') }}" width="60" height="60" alt="Product">
                                    </a>
                                    <div class="ps-2">
                                      <h6 class="mb-1"><a href="javascript:;" class="text-white">White Polo T-Shirt</a>
                                      </h6>
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                      <img src="{{ asset('asset/images/top-products/03.png') }}" width="60" height="60" alt="Product">
                                    </a>
                                    <div class="ps-2">
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                      <img src="{{ asset('asset/images/top-products/02.png') }}" width="60" height="60" alt="Product">
                                    </a>
                                    <div class="ps-2">
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                      <img src="{{ asset('asset/images/top-products/01.png') }}" width="60" height="60" alt="Product">
                                    </a>
                                    <div class="ps-2">
                      ...
                      <div class="modal-body">
                        <div class="row row-cols-1 row-cols-lg-4">
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/gallery/01.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/gallery/02.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/gallery/03.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/gallery/04.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/orders/01.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/orders/05.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/orders/03.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
                          ...
                          <div class="col">
                            <div class="card rounded-4">
                              <div class="card-body">
                                <img src="{{ asset('asset/images/orders/04.png') }}" class="img-fluid rounded-4" alt="">
                                <div class="mt-3">
                                  <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                                  <p class="mb-0 product-short-name">Color Printed Kurta</p>
                                  <div class="product-price d-flex align-items-center gap-2 mt-2">
