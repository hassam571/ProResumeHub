  ...
  <main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="row row-cols-1 row-cols-xl-2">
        ...
        <div class="col">
          <div class="card">
            <img src="{{ asset('asset/images/gallery/13.png') }}" class="img-fluid card-img-top" alt="">
            <div class="card-body p-4">
              ...
              <div class="mt-5">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-4">
                  <div class="col">
                    <div class="text-center">
                      <img src="{{ asset('asset/images/orders/01.png') }}" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Logo Design</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="{{ asset('asset/images/orders/02.png') }}" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Whiteboard & Animated</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="{{ asset('asset/images/orders/03.png') }}" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Voice Over</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="{{ asset('asset/images/orders/04.png') }}" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Wordpress</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="{{ asset('asset/images/orders/05.png') }}" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Articles & Blog Posts</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="{{ asset('asset/images/orders/06.png') }}" class="img-fluid rounded" alt="">
