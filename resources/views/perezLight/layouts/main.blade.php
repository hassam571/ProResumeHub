...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets3/css/vendor/bootstrap.min.css ')}} ">

    <!-- Plugins CSS (All Plugins Files) -->
    <link rel="stylesheet" href="{{ asset('assets3/css/plugins/aos.css ')}} ">
    <link rel="stylesheet" href="{{ asset('assets3/css/plugins/swiper-bundle.min.css ')}} ">
    <link rel="stylesheet" href="{{ asset('assets3/css/plugins/magnific-popup.css') }}">
    <!-- Style CSS -->
    <link rel="stylesheet" href="{{ asset('assets3/css/pages/home.css ')}} ">
    ...
    <header id="sticky-header" class="header position-absolute left-0 top-0 w-100 z-3">
        <div class="d-flex justify-content-between header-inner">
            ...
            <div class="header-border-bottom d-flex align-items-center justify-content-between flex-grow-1">
                ...
                <a href="{{ route('index',['username' => Auth::user()->username]) }}">
                    <img src="{{ asset('assets3/images/logo/logo.png ')}} " alt="logo">
                </a>

                <!-- Link Start -->
                <a href="{{ route('contact',['username' => Auth::user()->username]) }}" class="d-flex align-items-center flex-wrap fw-bold text-dark lh-1 contact-link hover-text-white">Let’s
                    Talk
    ...
    <div id="offcanvas" class="offcanvas offcanvas-end bg-dark d-flex flex-wrap flex-column justify-content-between">
        ...
        <div>
            <div class="d-flex flex-wrap justify-content-between align-items-center offcanvas-header">
                <a href="{{ route('index',['username' => Auth::user()->username]) }}">
                    <img src="{{ asset('assets3/images/logo/offcanvas-logo.png ')}} " alt="">
                </a>
            ...
            <nav class="offcanvas-nav d-flex flex-wrap flex-column justify-content-between">
                <ul class="offcanvas-menu p-0 list-unstyled">
                    <li class="offcanvas-menu-item">
                        <a href="{{ route('index',['username' => Auth::user()->username]) }}" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">Home
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="offcanvas-menu-item">
                        <a href="{{ route('about',['username' => Auth::user()->username]) }}" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">About
                            <span class="d-inline-block animate-arrow-up">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"></path>
                <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="offcanvas-menu-item">
                        <a href="{{ route('projects',['username' => Auth::user()->username]) }}" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">Project
                            <span class="d-inline-block animate-arrow-up">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"></path>
                <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="offcanvas-menu-item">
                        <a href="" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">Project
                            details
                            <span class="d-inline-block animate-arrow-up">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                ...
                <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="offcanvas-menu-item">
                        <a href="{{ route('blog',['username' => Auth::user()->username]) }}" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">Blog
                            <span class="d-inline-block animate-arrow-up">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"></path>
                <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="offcanvas-menu-item">
                        <a href="#" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">Blog
                            Details
                            <span class="d-inline-block animate-arrow-up">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                ...
                <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="offcanvas-menu-item">
                        <a href="{{ route('contact',['username' => Auth::user()->username]) }}" class="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link">Contact
                            <span class="d-inline-block animate-arrow-up">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"></path>
        ...
        <div class="container">
            <div class="overflow-x-hidden" data-aos="flip-down" data-aos-delay="500">
                <div class="footer-grid">
                    <div class="pt-12">
                        <h3 class="section-title text-white mb-0"><span class="position-relative circle-shape footer-shape">Le</span>
                            t’s work together</h3>
                        <div class="d-flex flex-wrap align-items-center mt-10">
                            <span class="text-xl fw-bold font-Syne text-white">Based in Germany |</span>
                    ...
                    <div class="d-flex flex-column justify-content-between service-contact-card-footer">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="text-2xl fw-bold font-Syne leading-none text-warning">hello@henry.com</p>
                    ...
                    <div class="d-flex flex-column justify-content-between service-contact-card-footer">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="text-2xl fw-bold font-Syne leading-none text-warning">+598 6879 9874</p>
                            <a href="#" class="text-white animate-arrow-up">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.6667 28.3334L28.3334 11.6667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11.6667 11.6667H28.3334V28.3334" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="py-72">
                            <svg class="w-100" width="1281" height="77" viewBox="0 0 1281 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="pt-6 copyright">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8 order-last order-sm-first">
                            <p class="text-white text-lg fw-normal font-sans leading-7"><footer>©<span id="currentYear"></span> Codefixxer, All Rights Reserved<script>document.getElementById('currentYear').textContent = new Date().getFullYear();</script></footer>
...
<!-- Vendors JS -->
<script src="{{ asset('assets3/js/vendor/modernizr-3.11.7.min.js ')}} "></script>
<script src="{{ asset('assets3/js/vendor/jquery-3.6.0.min.js ')}} "></script>
<script src="{{ asset('assets3/js/vendor/jquery-migrate-3.3.2.min.js ')}} "></script>
<script src="{{ asset('assets3/js/vendor/bootstrap.bundle.min.js ')}} "></script>

<!-- Plugins JS -->
<script src="{{ asset('assets3/js/plugins/aos.js ')}} ">
</script>
<script src="{{ asset('assets3/js/plugins/swiper-bundle.min.js ')}} ">
</script>
<script src="{{ asset('assets3/js/plugins/jquery.waypoints.js ')}} ">
</script>
<script src="{{ asset('assets3/js/plugins/jquery.magnific-popup.min.js') }}">
</script>
<script src="{{ asset('assets3/js/plugins/jquery.counterup.min.js ')}} ">
</script>
